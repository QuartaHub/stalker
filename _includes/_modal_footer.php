		...
		<div class="modal__main">
			...
			<div class="modal__content">
				<div class="modal-reviews__form">
					<div data-form-result style="display: none"></div>
					<form data-ajax-form>
                        ...
                        <div><input type="text" name="name" class="form-group__input form-group__input--right-indent" placeholder="Ваше имя" data-required=""></div>
						<div><input type="text" name="email" class="form-group__input" placeholder="Ваш e-mail" data-input-email="" data-required=""></div>
                        <div class="right-wrapper" data-stars-parent>
                            <div class="st-block">
                                <div class="st-title">Ваша оценка: <span class="stars-count" data-stars-count>-</span></div>
                                <div class="st-val">
                                    <div class="stars-block">
                                        <div class="stars-wrapper">
                                            <div class="stars stars-0"><input type="hidden" name="stars" value=""></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group__textarea_wrapper">
